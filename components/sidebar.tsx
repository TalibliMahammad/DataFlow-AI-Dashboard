...
export function Sidebar({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: (open: boolean) => void }) {
  ...
  const navigationItems = [
    ...
    {name:"API Management", href: "/dashboard/ApiManagementPage", icon: FileText },
      {name:"Al Models", href: "/dashboard/aimodels", icon: FileText },
      {name:"Billing & Subscriptions", href: "/dashboard//billing", icon: FileText },
