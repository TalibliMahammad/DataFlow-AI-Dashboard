...
function TrafficChart() {
    _s();
    // 1. Başlanğıc datanı state-ə qoyuruq
                ...
                "TrafficChart.useEffect.interval": ()=>{
                    setChartData({
                        "TrafficChart.useEffect.interval": (prevData)=>{
                            const lastTime = prevData[prevData.length - 1].name;
                            const [hours, minutes] = lastTime.split(':').map(Number);
                            // Yeni vaxtı hesabla (+5 dəqiqə)
                            ...
                            // Yeni təsadüfi dəyər (son dəyərə yaxın rəqəm ki, sıçrayış olmasın)
                            const lastValue = prevData[prevData.length - 1].value;
                            const newValue = Math.max(1000, Math.min(6000, lastValue + (Math.random() * 1000 - 500)));
                            // İlk elementi sil, yenisini axıra əlavə et (Sürüşmə effekti)
                            const newData = [
                                ...prevData.slice(1),
                                {
                                    name: newTime,
        ...
        "MetricsGrid.useEffect": ()=>{
            const interval = setInterval({
                "MetricsGrid.useEffect.interval": ()=>{
                    setMetrics({
                        "MetricsGrid.useEffect.interval": (prev)=>prev.map({
                                "MetricsGrid.useEffect.interval": (m)=>{
                                    // 1. Əsas dəyərin dəyişməsi
                                    const valueMovement = Math.random() * 0.02 - 0.01; // +-1% arası
                                    let newValue = m.value + m.value * valueMovement;
                                    // 2. "Change" faizinin dəyişməsi (məsələn, 12.5-dən 12.6-ya)
                                    const changeMovement = Math.random() * 0.4 - 0.2; // +-0.2% arası
                                    let newChange = m.change + changeMovement;
                                    // 3. Trendin avtomatik təyini (Opsional: əgər faiz 0-dan aşağı düşərsə)
                                    const newTrend = newChange >= 0 ? "up" : "down";
                                    // Rəqəmləri səliqəyə salaq
                                    if (m.id === 3 || m.id === 4) {
...
function Dashboard() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Chatbot, {}, void 0, false, {
...
//# sourceMappingURL=_c4befdee._.js.map