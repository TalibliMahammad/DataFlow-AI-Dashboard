...
function AuthSignupForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"].getState().signup({
                fullName: name,
                email: email,
                password: password
            }, "firebase");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41b43f35._.js.map