...
const handleSubmit = async (e)=>{
    e.preventDefault();
    // 1. Dataları dərhal DOM-dan götür (Ən dəqiq yol)
    ...
    // 2. Error state-ini yeni datalarla yenilə (Vizual üçün)
    ...
    // 3. Əgər hər hansı sahə BOŞDURSA - BURADA DAYAN
    if (!vName || !vEmail || !vPassword || !vConfirm) {
        setAlert({
            message: "Please fill in all required fields correctly.",
            type: "error"
        });
        return; // <--- Çox vacib! Signup-a keçidi bloklayır.
    }
    ...
    // 6. Əgər bura çatdısa, məlumatlar 100% doğrudur
    setIsLoading(true);
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5870e57._.js.map