...
function AuthLoginForm() {
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])((state)=>state);
...
function AuthSignupForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        const vName = formData.get("name");
        const vEmail = formData.get("email");
        ...
        if (!vName || !vEmail || !vPassword || !vConfirm) {
            ...
            return; // Kod burada qırılır, aşağı keçmir (Düzgündür)
        }
        if (!passwordRegex.test(password)) {
            setAlert({
                message: "Şifrə tələblərə cavab vermir (Böyük, kiçik hərf və rəqəm).",
                type: "error"
            });
            return;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c432d5aa._.js.map