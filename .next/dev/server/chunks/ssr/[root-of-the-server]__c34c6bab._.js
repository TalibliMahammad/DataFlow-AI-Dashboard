...
function ChatBot() {
    ...
    Ümumi Satış: 5000 AZN, 
    Müştəri Sayı: 120 nəfər, 
    Aylıq Artım: 15%, 
    Problem: 5 müştəri şikayəti var.
  `;
        const fullPrompt = `
    Sənə təqdim olunan Dashboard məlumatları: ${dashboardStats}
    İstifadəçinin sualı: ${currentInput}
    
    Xahiş edirəm, yalnız bu datalara əsaslanaraq və peşəkar bir biznes analitik kimi cavab ver.
  `;
        try {
            const response = await fetch("../app/api/chatConfig.ts", {
                method: "POST",
                headers: {
            ...
            const errorMsg = {
                role: "ai",
                text: "Bağışlayın, sistemdə xəta baş verdi. Yenidən yoxlayın."
            };
            setMessages((prev)=>[
                    ...prev,
                    errorMsg
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c34c6bab._.js.map